...
exports.addPipeline = {
  'spec': {
    path : "/pipeline",
    notes : "adds a pipeline to the store",
    summary : "Add a new pipeline to the store",
    method: "POST",
    parameters : [param.body("Pipeline", "Pipeline object that needs to be added to the store", "Pipeline")],
    responseMessages : [swe.invalid('input')],
    nickname : "addPipeline"
  },  
  'action': function(req, res) {
    var body = req.body;
    if(!body || !body.id){
